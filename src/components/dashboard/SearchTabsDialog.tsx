  ...
  return (
    <div className="w-full">
      <Dialog open={open} onOpenChange={handleOpenChange}>
        ...
        <DialogTrigger className="w-full flex items-center justify-baseline gap-3 px-3 mb-3 cursor-pointer bg-zinc-900 border border-zinc-700 h-11 hover:ring-2 hover:ring-white/20 transition">
